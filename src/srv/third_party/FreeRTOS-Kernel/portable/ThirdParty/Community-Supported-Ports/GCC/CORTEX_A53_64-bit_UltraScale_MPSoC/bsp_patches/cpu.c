...
static uint32_t ReleaseReset_A53(uint32_t CpuID)
{
    ...
    switch (CpuID)
    {
        case CPU_A53_0:
            ...
            RegValue &=
                ~(CRF_APB_RST_FPD_APU_ACPU0_RESET_MASK | CRF_APB_RST_FPD_APU_APU_L2_RESET_MASK |
        ...
        case CPU_A53_1:
            ...
            RegValue = Xil_In32(CRF_APB_RST_FPD_APU);
            RegValue &=
                ~(CRF_APB_RST_FPD_APU_ACPU1_RESET_MASK | CRF_APB_RST_FPD_APU_APU_L2_RESET_MASK |
                  CRF_APB_RST_FPD_APU_ACPU1_PWRON_RESET_MASK);
            Xil_Out32(CRF_APB_RST_FPD_APU, RegValue);
            break;

        case CPU_A53_2:
            PwrStateMask = PMU_GLOBAL_PWR_STATE_ACPU2_MASK | PMU_GLOBAL_PWR_STATE_FP_MASK |
                           PMU_GLOBAL_PWR_STATE_L2_BANK0_MASK;
            Status = PowerUpIsland(PwrStateMask);
            if (Status != CPU_OK)
            {
            ...
            RegValue = Xil_In32(CRF_APB_RST_FPD_APU);
            RegValue &=
                ~(CRF_APB_RST_FPD_APU_ACPU2_RESET_MASK | CRF_APB_RST_FPD_APU_APU_L2_RESET_MASK |
                  CRF_APB_RST_FPD_APU_ACPU2_PWRON_RESET_MASK);
            Xil_Out32(CRF_APB_RST_FPD_APU, RegValue);
            break;

        case CPU_A53_3:
            PwrStateMask = PMU_GLOBAL_PWR_STATE_ACPU3_MASK | PMU_GLOBAL_PWR_STATE_FP_MASK |
                           PMU_GLOBAL_PWR_STATE_L2_BANK0_MASK;
            Status = PowerUpIsland(PwrStateMask);
            if (Status != CPU_OK)
            {
            ...
            RegValue = Xil_In32(CRF_APB_RST_FPD_APU);
            RegValue &=
                ~(CRF_APB_RST_FPD_APU_ACPU3_RESET_MASK | CRF_APB_RST_FPD_APU_APU_L2_RESET_MASK |
