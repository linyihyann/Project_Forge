 ...
 * </pre>
 *
 * @note Copied from xfsbl_hw.h of 'zynqmp_fsbl'
 *
 ******************************************************************************/
...
#if !defined(FSBL_PERF_EXCLUDE) && \
    (!defined(ARMR5) || (defined(ARMR5) && defined(SLEEP_TIMER_BASEADDR)))
#define XFSBL_PERF
#endif
...
#if defined(XPAR_PSU_DDR_0_S_AXI_BASEADDR) || defined(XPAR_PSU_R5_DDR_0_S_AXI_BASEADDR)
#define XFSBL_PS_DDR
#endif
...
#if (!defined(FSBL_USB_EXCLUDE) && defined(XPAR_XUSBPSU_0_DEVICE_ID) && \
     (XPAR_XUSBPSU_0_BASEADDR == 0xFE200000) && defined(XFSBL_PS_DDR))
#define XFSBL_USB
#endif
...
#define EFUSE_IPDISABLE_CG_MASK                                         \
    ((EFUSE_IPDISABLE_GPU_DIS_MASK) | (EFUSE_IPDISABLE_APU2_DIS_MASK) | \
     (EFUSE_IPDISABLE_APU3_DIS_MASK))
