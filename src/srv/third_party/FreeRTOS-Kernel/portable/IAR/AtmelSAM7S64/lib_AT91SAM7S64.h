...
#define AT91C_I2S_ASY_MASTER_TX_SETTING(nb_bit_by_slot, nb_slot_by_frame)          \
    (+AT91C_SSC_CKS_DIV + AT91C_SSC_CKO_CONTINUOUS + AT91C_SSC_CKG_NONE +          \
...
#define AT91C_I2S_ASY_TX_FRAME_SETTING(nb_bit_by_slot, nb_slot_by_frame)                          \
    (+(nb_bit_by_slot - 1) + AT91C_SSC_MSBF + (((nb_slot_by_frame - 1) << 8) & AT91C_SSC_DATNB) + \
...
/** \brief Return 2 if PDC has been initialized with Buffer and Next Buffer, 1 if PDC has been
 * initialized with Next Buffer, 0 if PDC is busy */
/**---------------------------------------------------------------------------- */
__inline unsigned int AT91F_SSC_ReceiveFrame(AT91PS_SSC pSSC, char* pBuffer, unsigned int szBuffer,
                                             char* pNextBuffer, unsigned int szNextBuffer)
{
    return AT91F_PDC_ReceiveFrame((AT91PS_PDC) & (pSSC->SSC_RPR), pBuffer, szBuffer, pNextBuffer,
                                  szNextBuffer);
}
...
__inline unsigned int AT91F_SPI_ReceiveFrame(AT91PS_SPI pSPI, char* pBuffer, unsigned int szBuffer,
                                             char* pNextBuffer, unsigned int szNextBuffer)
{
    return AT91F_PDC_ReceiveFrame((AT91PS_PDC) & (pSPI->SPI_RPR), pBuffer, szBuffer, pNextBuffer,
                                  szNextBuffer);
}
...
/** \brief Return 2 if PDC has been initialized with Buffer and Next Buffer, 1 if PDC has been
 * initialized with Next Buffer, 0 if PDC is bSPIy */
/**---------------------------------------------------------------------------- */
                                   ...
                                   unsigned int sample_and_hold_time) /* in ns */
{
    ...
    /** Write to the MR register */
    pADC->ADC_MR = ((prescal << 8) & AT91C_ADC_PRESCAL) | ((startup << 16) & AT91C_ADC_STARTUP) |
...
#define AT91C_US_ASYNC_MODE                                                                      \
    (AT91C_US_USMODE_NORMAL + AT91C_US_NBSTOP_1_BIT + AT91C_US_PAR_NONE + AT91C_US_CHRL_8_BITS + \
     AT91C_US_CLKS_CLOCK)
...
#define AT91C_US_ISO_READER_MODE                                                                   \
    (AT91C_US_USMODE_ISO7816_0 + AT91C_US_CLKS_CLOCK + AT91C_US_NBSTOP_1_BIT + AT91C_US_PAR_EVEN + \
     AT91C_US_CHRL_8_BITS + AT91C_US_CKLO + AT91C_US_OVER)
...
{
    return AT91F_PDC_ReceiveFrame((AT91PS_PDC) & (pUSART->US_RPR), pBuffer, szBuffer, pNextBuffer,
                                  szNextBuffer);
}
    ...
    void (*Handler)())     /* \arg Interrupt Handler */
{
    ...
    {
        *pVector = (((((unsigned int)Handler) - ((unsigned int)pVector) - 0x8) >> 2) & 0x00FFFFFF) |
                   0xEA000000;
    }
...
__inline void AT91F_DBGU_CfgPIO(void)
{
    ...
    AT91F_PIO_CfgPeriph(
        ...
        ((unsigned int)AT91C_PA10_DTXD) | ((unsigned int)AT91C_PA9_DRXD), /* Peripheral A */
        0);                                                               /* Peripheral B */
}
...
__inline void AT91F_PWMC_CH3_CfgPIO(void)
{
    ...
    AT91F_PIO_CfgPeriph(
        AT91C_BASE_PIOA, /* PIO controller base address */
        0,               /* Peripheral A */
        ((unsigned int)AT91C_PA14_PWM3) | ((unsigned int)AT91C_PA7_PWM3)); /* Peripheral B */
}
...
__inline void AT91F_PWMC_CH2_CfgPIO(void)
{
    ...
    AT91F_PIO_CfgPeriph(
        ...
        ((unsigned int)AT91C_PA25_PWM2) | ((unsigned int)AT91C_PA13_PWM2)); /* Peripheral B */
}
...
__inline void AT91F_PMC_CfgPIO(void)
{
    ...
    AT91F_PIO_CfgPeriph(AT91C_BASE_PIOA, /* PIO controller base address */
                        ...
                        ((unsigned int)AT91C_PA17_PCK1) | ((unsigned int)AT91C_PA21_PCK1) |
                            ((unsigned int)AT91C_PA31_PCK2) | ((unsigned int)AT91C_PA18_PCK2) |
...
__inline void AT91F_TWI_CfgPIO(void)
{
    ...
    AT91F_PIO_CfgPeriph(
        AT91C_BASE_PIOA, /* PIO controller base address */
        ((unsigned int)AT91C_PA3_TWD) | ((unsigned int)AT91C_PA4_TWCK), /* Peripheral A */
        0);                                                             /* Peripheral B */
}
